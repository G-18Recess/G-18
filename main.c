...
if(mysql_query(conn,"SELECT * FROM pupils; ")){
...
//if (mysql_query(conn, "insert into requests ( schoolcode, petition) values ( "1200","activateme");") != 0)
    //
...
}    else {printf("wrong password kid!\n");
